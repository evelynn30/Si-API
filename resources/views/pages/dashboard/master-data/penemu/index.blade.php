        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <x-partials.elements.buttons.add :href="route('penemu.create')" />
                </div>
            </div>
            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table-striped table-md table">
                                ...
                                @foreach ($penemu as $item)
                                    <tr>
                                        <td class="text-center">{{ $penemu->firstItem() + $loop->index }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="group d-flex align-items-center justify-content-center"
                                                style="gap: 5px;">
                                                <x-partials.elements.buttons.tables.info :href="route('penemu.show', $item->id)" />
                                                <x-partials.elements.buttons.tables.update :href="route('penemu.edit', $item->id)" />
                                                <x-partials.elements.buttons.tables.destroy :id="$item->id"
                                                    :nama="$item->nama" :href="route('penemu.destroy', $item->id)" />
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="card-footer">
                        <x-partials.elements.pagination :paginator="$penemu" />
                    </div>
                </div>
            </div>
        </section>
