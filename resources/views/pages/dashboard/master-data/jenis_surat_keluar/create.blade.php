...
@section('title', 'Tambah Data Jenis Surat Keluar')
    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <form action="{{ route('jenis_surat_keluar.store') }}" method="POST" autocomplete="off">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <div class="row">
                                <div class="col-md-6">
                                    <x-partials.elements.form-group.input label="Jenis Surat Keluar" name="nama" id="nama"
                                        :value="old('nama')" />
                                </div>
                                <div class="col-md-6">
