    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <form action="{{ route('surat_keluar.store') }}" method="POST" autocomplete="off"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <x-partials.elements.form-group.select-group label="Jenis Surat"
                                        name="jenis_surat_keluar" id="jenis-surat" :options="$jenisSuratKeluar" :value="old('jenis_surat_keluar', 1)" />
                                </div>
                                <div class="col-md-12 {!! old('jenis_surat_keluar', 1) != 1 ? 'd-none' : '' !!}" id="col-data-temuan">
                                    <x-partials.elements.form-group.select-multiple label="Data Temuan" name="data_temuan"
                                        placeholder="Pilih Data Temuan" :options="$temuan" :value="old('data_temuan')" />
                                </div>
