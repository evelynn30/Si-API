    ...
    <div class="row">
        <div class="col-12 col-md-8 col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h4>Jumlah Surat Keluar dari setiap OPD</h4>
                </div>
                <div class="card-body">
                    @foreach ($opd as $item)
                        <div class="mb-4">
        ...
        <div class="col-12 col-md-4 col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <canvas id="jenis-surat-keluar"></canvas>
                </div>
            </div>
        </div>
    </div>
...
{{-- diagram --}}
<script>
    function initializeChartsSuratKeluar() {
        "use strict";
        var ctx = document.getElementById("jenis-surat-keluar").getContext('2d');
        var myChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                datasets: [{
                    data: {!! json_encode($chartJenisSuratKeluar['jumlah']) !!},
                    backgroundColor: [
                        '#63ed7a',
                        '#6777ef',
                        '#ffa426',
                ...
                labels: {!! json_encode($chartJenisSuratKeluar['jenis']) !!},
            },
            options: {
                responsive: true,
                legend: {
