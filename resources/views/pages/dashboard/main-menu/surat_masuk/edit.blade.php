    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <form action="{{ route('surat_masuk.update', $suratMasuk->id) }}" method="POST" autocomplete="off"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <x-partials.elements.form-group.select-group label="Jenis Surat"
                                        name="jenis_surat_masuk" id="jenis-surat" :options="$jenisSuratMasuk" :value="old('jenis_surat_masuk', $suratMasuk->jenis_surat_masuk_id)" />
                                </div>
                                <div class="col-md-12 {!! old('jenis_surat_masuk', 1) != 1 ? 'd-none' : '' !!}" id="col-data-surat-keluar">
                                    <x-partials.elements.form-group.select-multiple label="Data Surat Keluar"
                                        ...
                                        :value="old('data_surat_keluar', $selectedSuratKeluar)" />
                                </div>
                                ...
                                <div class="col-md-6">
                                    <x-partials.elements.form-group.input label="Tanggal" type="date" name="tanggal"
                                        id="tanggal" :value="old('tanggal', $suratMasuk->tanggal)" />
                                </div>
                                <div class="col-md-6">
                                    <x-partials.elements.form-group.input label="Nomor Surat" name="nomor" id="nomor"
                                        :value="old('nomor', $suratMasuk->nomor)" />
                                </div>
                                <div class="col-md-6">
                                    <x-partials.elements.form-group.select label="Sifat Surat" name="sifat_surat"
                                        placeholder="Pilih Sifat Surat" :options="$sifatSurat" :value="old('sifat_surat', $suratMasuk->sifat_surat_id)" />
                                </div>
                                <div class="col-md-6">
                                    <x-partials.elements.form-group.select label="Perihal Surat" name="perihal_surat"
                                        placeholder="Pilih Perihal Surat" :options="$perihalSurat" :value="old('perihal_surat', $suratMasuk->perihal_surat_id)" />
                                </div>
                            </div>
                            <x-partials.elements.form-group.upload-file label="File Surat (sudah ttd/tte)" name="file"
                                id="file" placeholder="Upload File" :value="$suratMasuk->file"
                                path="uploads/documents/surat-masuk/" />
                        </div>
